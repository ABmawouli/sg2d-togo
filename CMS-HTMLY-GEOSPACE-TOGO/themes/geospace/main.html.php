...
<?php if (isset($is_taxonomy)): ?>
    <div class="space-y-2 pb-8 pt-6 md:space-y-5">
        ...
        <div class="space-y-2 md:space-y-5">
            <h2 class="text-2xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-4xl md:leading-14">
                Articles récents
            </h2>
        </div>
...
<?php $teaserType = config('teaser.type');
$readMore = config('read.more'); ?>
