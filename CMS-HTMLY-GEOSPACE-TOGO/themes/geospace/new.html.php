...
<section class="mx-auto max-w-3xl px-4 sm:px-6 xl:max-w-5xl xl:px-0">
    <div class="flex h-screen flex-col justify-between font-sans">
        ...
        <!-- Header -->
        <header class="flex items-center justify-between py-10 bg-sky-300"> <!-- Bleu ciel -->
            <div>
                <a aria-label="<?php echo blog_title();?>" href="<?php echo site_url();?>">
                    <div class="flex items-center justify-between">
                        <div class="mr-3">
                            <img class="w-32 h-auto" src="<?php echo theme_path();?>logo.jpeg" alt="<?php echo blog_title();?>"/>
                        </div>
        ...
        <footer>
            <div class="mt-16 flex flex-col items-center">
                ...
                <div class="mb-8 text-sm text-gray-500 dark:text-gray-400">Design by <a target="_blank" rel="nofollow" href="https://www.timlrx.com/">Timlrx</a></div>
            </div>
        </footer>
...
<!-- Search Form -->
<div class="fixed inset-0 flex items-start justify-center w-full p-16 z-50 bg-gray-300/50 backdrop-blur dark:bg-black/50 search-form">
    <div class="w-full max-w-xl scale-99 opacity-100 pointer-events-auto">
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-center space-x-4 p-4">
                <span class="block w-5">
                    <svg class="text-gray-400 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                </span>
                <form role="search" class="w-full">
                    <input name="search" class="h-8 w-full bg-transparent text-gray-600 placeholder-gray-400 focus:outline-none dark:text-gray-200 dark:placeholder-gray-500" autocomplete="off" placeholder="<?php echo i18n('type_to_search');?>">
                </form>
